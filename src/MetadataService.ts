...
export class MetadataService {
    ...
    resetSigningKeys() {
        // TODO: port-TS this._settings = this._settings || {}
    ...
    getTokenEndpoint(optional=true): Promise<string> {
        return this._getMetadataProperty("token_endpoint", optional) as Promise<string>;
    }

    getCheckSessionIframe(): Promise<string> {
        return this._getMetadataProperty("check_session_iframe", true) as Promise<string>;
    }

    getEndSessionEndpoint(): Promise<string> {
        return this._getMetadataProperty("end_session_endpoint", true) as Promise<string>;
    }

    getRevocationEndpoint(): Promise<string> {
        return this._getMetadataProperty("revocation_endpoint", true) as Promise<string>;
    }

    getKeysEndpoint(): Promise<string> {
        return this._getMetadataProperty("jwks_uri", true) as Promise<string>;
    }
    ...
    getSigningKeys() {
        ...
        return this._getMetadataProperty("jwks_uri").then(jwks_uri => {
            ...
            return this._jsonService.getJson(jwks_uri as string /*TODO: port-TS*/).then(keySet => {
