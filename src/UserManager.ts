...
type AnyNavigator = IFrameNavigator | PopupNavigator | RedirectNavigator | CordovaIFrameNavigator

export class UserManager extends OidcClient {
    protected _settings!: UserManagerSettings /* TODO: port-ts */
    ...
    signinPopupCallback(url: string) {
    ...
    _signin(args: any, navigator: AnyNavigator, navigatorParams: any = {}): Promise<User> {
        return this._signinStart(args, navigator, navigatorParams).then((navResponse: any) => {
            return this._signinEnd(navResponse.url, args);
        });
    }
    _signinStart(args: any, navigator: AnyNavigator, navigatorParams: any = {}) {
        // @ts-ignore
    ...
    _signinCallback(url: string, navigator: IFrameNavigator | PopupNavigator): Promise<User> {
    ...
    _signout(args: any, navigator: AnyNavigator, navigatorParams: any = {}) {
        return this._signoutStart(args, navigator, navigatorParams).then((navResponse: any) => {
            return this._signoutEnd(navResponse.url);
        });
    }
    _signoutStart(args: any = {}, navigator: AnyNavigator, navigatorParams: any = {}) {
        // @ts-ignore
        return navigator.prepare(navigatorParams).then(handle => {
